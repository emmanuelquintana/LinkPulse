...
export default function CreateLinkPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto font-sans">
      ...
      <div className="mb-8">
        <Link href="/dashboard/links" className="inline-flex items-center text-sm font-semibold text-gray-500 hover:text-indigo-600 mb-4 transition-colors">
          <span className="material-symbols-outlined text-[18px] mr-1">arrow_back</span>
          Back to Links
        </Link>
        <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Create new link</h2>
        <p className="text-gray-500 mt-2">Generate a short URL to share with your audience and track its performance.</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-gray-900 block">Workspace</label>
            <p className="text-[0.8rem] text-gray-500 mb-2 font-medium">Select the workspace where this link will be managed.</p>
            <select 
              required
          ...
          <div className="space-y-2">
            <label className="text-sm font-bold text-gray-900 block">Destination URL</label>
            <p className="text-[0.8rem] text-gray-500 mb-2 font-medium">The long URL where visitors will be redirected to.</p>
            <input 
              type="url" 
              required 
          ...
          <div className="space-y-2">
            ...
            <p className="text-[0.8rem] text-gray-500 mb-2 font-medium">Associate this link with a marketing campaign.</p>
            <select 
            ...
            {campaigns.length === 0 && !loadingCampaigns && selectedWorkspace && (
              <p className="text-[0.7rem] text-indigo-500 font-medium">No campaigns found in this workspace.</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <p className="text-[0.8rem] text-gray-500 mb-2 font-medium">Identify your link internally.</p>
              <input 
                type="text" 
            ...
            <div className="space-y-2">
              ...
              <p className="text-[0.8rem] text-gray-500 mb-2 font-medium">Create a branded, memorable short link.</p>
